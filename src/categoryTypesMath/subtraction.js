    ...
    return (
        ...
        <div className="title-container">        
            <div className="container-fluid">
                <div className="row">
                <div className="col-xs-1 text-center"><h1>Subtraction Levels</h1></div>
                </div>
            </div>
            </div>
        <div className="row">
        <div className="col-sm-6">
            ...
            <div className="card-body">
                ...
                <a href="#" className="btn btn-primary"><Link style={{color: 'white',textDecoration: 'none'}} to="/levels/quizzes/subtractionQuiz">Level 1</Link></a>
            </div>
            </div>
            </div>
        </div>
