...
import multiplicationData2 from "../../DataFiles/multiplicationData/multiplicationData2";
import { multiplicationQuiz2Complete } from "../multiplicationQuiz2Complete.js";

import "../Quizzes.css";



let data = multiplicationData2;
                ...
                <Modal.Footer>
                  ...
                  >
                    <div className="d-grid gap-2">
                      <Button
                        variant="primary"
                         onClick={() => {this.setState({ showModal: false }); multiplicationQuiz2Complete ();}}
                      >
                        Collect Badge
                      </Button>
                    </div>
