...
import additionData4 from "../../DataFiles/additionData/additionData4";
import "../Quizzes.css";
import {additionQuiz4Complete} from "../quizCompleteadd4";


let data = additionData4;
...
class Quiz extends React.Component {
  ...
  constructor(props) {
    ...
    var random = Math.floor(Math.random() * 3600);
    this.state = {
      nr: random,
      showButton: false,
  ...
  pushData(nr) {
    ...
    if (correctlyAnswered.length > 0){
      while (correctlyAnswered.includes(random) || nr === random){
        random = Math.floor(Math.random() * 3600);
      }
    }
                ...
                <Modal.Footer>
                  ...
                  >
                    <div className="d-grid gap-2">
                      <Button
                        variant="primary"
                        onClick={() => {this.setState({ showModal: false });additionQuiz4Complete();}}
                      >
                        Collect Badge
                      </Button>
                    </div>
