...
import divisionData6 from "../../DataFiles/divisionData/divisionData6";
import { divisionQuiz6Complete } from "../divisionQuiz6Complete.js";
import "../Quizzes.css";



let data = divisionData6;
...
class Quiz extends React.Component {
  ...
  constructor(props) {
    ...
    var random = Math.floor(Math.random() * 746);
    this.state = {
      nr: random,
      showButton: false,
  ...
  pushData(nr) {
    ...
    if (correctlyAnswered.length > 0){
      while (correctlyAnswered.includes(random) || nr === random){
        random = Math.floor(Math.random() * 746);
      }
    }
                ...
                <Modal.Footer>
                  ...
                  >
                    <div className="d-grid gap-2">
                      <Button
                        variant="primary"
                         onClick={() => {this.setState({ showModal: false }); divisionQuiz6Complete ();}}
                      >
                        Collect Badge
                      </Button>
                    </div>
