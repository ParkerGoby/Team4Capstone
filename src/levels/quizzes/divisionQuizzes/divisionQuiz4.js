...
import divisionData4 from "../../DataFiles/divisionData/divisionData4";
import { divisionQuiz4Complete } from "../divisionQuiz4Complete.js";
import "../Quizzes.css";



let data = divisionData4;
  ...
  pushData(nr) {
    ...
    if (correctlyAnswered.length > 0){
      while (correctlyAnswered.includes(random) || nr === random){
        random = Math.floor(Math.random() * 280);
      }
    }
                ...
                <Modal.Footer>
                  ...
                  >
                    <div className="d-grid gap-2">
                      <Button
                        variant="primary"
                         onClick={() => {this.setState({ showModal: false }); divisionQuiz4Complete ();}}
                      >
                        Collect Badge
                      </Button>
                    </div>
