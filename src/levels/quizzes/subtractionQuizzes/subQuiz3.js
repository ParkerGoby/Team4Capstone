...
import subtractionData3 from "../../DataFiles/subtractionData/subtractionData3";
import { subtractionQuiz3Complete } from "../subtractionQuiz3Complete.js";
import "../Quizzes.css";



let data = subtractionData3;
...
class Quiz extends React.Component {
  ...
  constructor(props) {
    ...
    var random = Math.floor(Math.random() * 1365);
    this.state = {
      nr: random,
      showButton: false,
  ...
  pushData(nr) {
    ...
    if (correctlyAnswered.length > 0){
      while (correctlyAnswered.includes(random) || nr === random){
        random = Math.floor(Math.random() * 1365);
      }
    }
                ...
                <Modal.Footer>
                  ...
                  >
                    <div className="d-grid gap-2">
                      <Button
                        variant="primary"
                         onClick={() => {this.setState({ showModal: false }); subtractionQuiz3Complete ();}}
                      >
                        Collect Badge
                      </Button>
                    </div>
