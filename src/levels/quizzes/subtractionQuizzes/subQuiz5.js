...
import subtractionData5 from "../../DataFiles/subtractionData/subtractionData5";
import { subtractionQuiz5Complete } from "../subtractionQuiz5Complete.js";
import "../Quizzes.css";



let data = subtractionData5;
...
class Quiz extends React.Component {
  ...
  constructor(props) {
    ...
    var random = Math.floor(Math.random() * 1911);
    this.state = {
      nr: random,
      showButton: false,
  ...
  pushData(nr) {
    ...
    if (correctlyAnswered.length > 0){
      while (correctlyAnswered.includes(random) || nr === random){
        random = Math.floor(Math.random() * 1911);
      }
    }
                ...
                <Modal.Footer>
                  ...
                  >
                    <div className="d-grid gap-2">
                      <Button
                        variant="primary"
                         onClick={() => {this.setState({ showModal: false }); subtractionQuiz5Complete ();}}
                      >
                        Collect Badge
                      </Button>
                    </div>
