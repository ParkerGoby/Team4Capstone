...
import subtractionData4 from "../../DataFiles/subtractionData/subtractionData4";
import { subtractionQuiz4Complete } from "../subtractionQuiz4Complete.js";
import "../Quizzes.css";



let data = subtractionData4;
...
class Quiz extends React.Component {
  ...
  constructor(props) {
    ...
    var random = Math.floor(Math.random() * 1410);
    this.state = {
      nr: random,
      showButton: false,
  ...
  pushData(nr) {
    ...
    if (correctlyAnswered.length > 0){
      while (correctlyAnswered.includes(random) || nr === random){
        random = Math.floor(Math.random() * 1410);
      }
    }
                ...
                <Modal.Footer>
                  ...
                  >
                    <div className="d-grid gap-2">
                      <Button
                        variant="primary"
                         onClick={() => {this.setState({ showModal: false }); subtractionQuiz4Complete ();}}
                      >
                        Collect Badge
                      </Button>
                    </div>
