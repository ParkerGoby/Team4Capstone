...
import subtractionData2 from "../../DataFiles/subtractionData/subtractionData2";
import { subtractionQuiz2Complete } from "../subtractionQuiz2Complete.js";
import "../Quizzes.css";



let data = subtractionData2;
                ...
                <Modal.Footer>
                  ...
                  >
                    <div className="d-grid gap-2">
                      <Button
                        variant="primary"
                         onClick={() => {this.setState({ showModal: false }); subtractionQuiz2Complete ();}}
                      >
                        Collect Badge
                      </Button>
                    </div>
